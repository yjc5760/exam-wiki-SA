...
![SA-2017-2 題目重繪：兩端固定梁，c 點設內鉸，全跨受向下均佈載重 w，並列出靜不定度的計算（4 未知 − 3 方程 = 1）](../../raw/solutions/SA-2017-2/figs/SA-2017-2-fig-1-beam.svg)
...
![SA-2017-2 代表案例 m/L=0.4 的三聯圖：載重與支承（含內鉸）、剪力圖（+53.93 到 −46.07，零點 x=5.393 m）、彎矩圖（兩端皆 hogging，內鉸處 M=0）](../../raw/solutions/SA-2017-2/figs/SA-2017-2-fig-3-vm.svg)
...
![SA-2017-2 固端彎矩隨鉸點位置變化的曲線：|M_a| 與 |M_b| 除以 wL² 對 m/L 作圖，與無內鉸的 wL²/12 基準線對照，m=n 時兩者皆為 wL²/8](../../raw/solutions/SA-2017-2/figs/SA-2017-2-fig-2-curve.svg)
