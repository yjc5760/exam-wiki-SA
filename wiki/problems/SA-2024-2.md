...
*圖說：總跨度共 7 個節點 (A~G)，每節點間距 4m。支承位於 B (滾支承) 與 F (鉸支承)。上方節點 H~N 高度為 3m，且每個上弦節點正下方均有一垂直桿與下弦對應節點相連 (H-A、I-B、J-C、K-D、L-E、M-F、N-G，共 7 根)。斜桿另呈現 Pratt 桁架配置 (V字型)：H-B、B-J、J-D、D-L、L-F、F-N，共 6 根。*

![SA-2024-2 完整桁架幾何重繪：下弦6＋上弦6＋垂直7＋斜桿6＝25根桿件](../../raw/solutions/SA-2024-2/figs/SA-2024-2-fig-1-frame.svg)

*圖 2　題目重繪（向量版）。原圖說僅描述斜桿而漏提垂直桿，本圖將全部 25 根桿件明確畫出，並標示待求誤差桿 CD、DE 與量測點 C、E。*
...
*圖解補繪：2026-08-27（向量圖，腳本 `gen_SA-2024-2.py`，可重跑）*
