...
![SA-2014-4 題目重繪與 CD 柱自由體：左為 L 型剛架幾何與支承，右為柱的隔離體並標出切斷面的 N、V、M 三個內力（V=0、M=0）](figs/SA-2014-4-fig-1-frame-fbd.svg)
...
![SA-2014-4 彎矩圖：AC 梁的彎矩由 A 端 −45 kN-m 變到 B 點 +37.5 kN-m，在 x=3.273 m 處通過零點；CD 柱彎矩恆為零](figs/SA-2014-4-fig-2-bmd.svg)
...
![SA-2014-4 變形形狀：梁向下撓曲、C 點垂直位移為零、節點 C 逆時針轉 0.09 rad，柱保持直線僅隨 C 剛體轉動](figs/SA-2014-4-fig-3-deflected.svg)
