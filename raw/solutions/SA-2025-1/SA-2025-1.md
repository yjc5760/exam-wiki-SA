...
![向量重繪：門型剛構架，節點 A/B/C/D、EI 與 L 標註、固定支承符號、側向力 P](figs/SA-2025-1-fig-1-frame.svg)
...
![自由度辨識圖解：保留 θB、θC、Δ 三個自由度，並標示被忽略軸向變形消去的垂直位移與水平位移耦合](figs/SA-2025-1-fig-2-dof.svg)
...
![勁度矩陣三行的物理意義：三個單位位移狀態及其所需節點力](figs/SA-2025-1-fig-3-unit-states.svg)
...
![變形形狀與彎矩圖：柱雙曲率、反曲點在距柱底 4L/7 處，梁反對稱、中點彎矩為零](figs/SA-2025-1-fig-4-deflected-bmd.svg)
...
![側向勁度光譜：梁無限剛 24EI/L³、本題 16.8EI/L³、梁無勁度 6EI/L³](figs/SA-2025-1-fig-5-stiffness-spectrum.svg)
